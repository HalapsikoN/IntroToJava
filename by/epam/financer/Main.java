...
public class Main {
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.println(controller.executeTask("ADD_ACCOUNT Kirill 3233 310 no"));
        System.out.println(controller.executeTask("GET_ACCOUNT Kirill 555"));
        System.out.println(controller.executeTask("UPDATE_ACCOUNT Kirill 679 700 yes"));
        System.out.println(controller.executeTask("DELETE_ACCOUNT Kirill 333"));
